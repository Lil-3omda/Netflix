...
@Component({
  ...
  templateUrl: './PublishedMovies.html',
  styleUrl: './PublishedMovies.css'
})
export class PublishedMovies implements OnInit {
  ...
  loadMoviesStatistics(): void {
    this.dashboardServices.getPublishedMovies().subscribe({
      next: data=>{
