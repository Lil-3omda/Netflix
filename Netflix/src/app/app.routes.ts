...
export const routes: Routes = [
  ...
  { path: 'category/:name', loadComponent: () => import('./shared/category/category').then(m => m.Category) },
  { path: 'moviedetails/:id', loadComponent: () => import('./pages/movive-detalis/movive-detalis').then(m => m.MoviveDetalis) },
  { path: 'profile', loadComponent: () => import('./features/profile/choose-profile/choose-profile').then(m => m.ChooseProfile) },

  // Static footer pages
  { path: 'only-on-netflix', loadComponent: () => import('./features/Footer/only-on-netflix').then(m => m.OnlyOnNetflixComponent) },
  { path: 'account', loadComponent: () => import('./features/Footer/account').then(m => m.AccountComponent) },
  { path: 'corporate-information', loadComponent: () => import('./features/Footer/corporate-info').then(m => m.CorporateInfoComponent) },
  { path: 'ways-to-watch', loadComponent: () => import('./features/Footer/ways-to-watch').then(m => m.WaysToWatchComponent) },
  { path: 'privacy', loadComponent: () => import('./features/Footer/privacy.component').then(m => m.PrivacyComponent) },
  { path: 'speed-test', loadComponent: () => import('./features/Footer/speed-test.component').then(m => m.SpeedTestComponent) },

  // Dashboard/Browse
  { path: 'browse', loadComponent: () => import('./features/dashboard/dashboard.component').then(m => m.DashboardComponent) },

  // Admin modern layout (with AuthGuard)
  {
    path: 'admin',
    ...
    children: [
      ...
      { path: 'reviews', loadComponent: () => import('./admin/pages/reviews/reviews.component').then(m => m.ReviewsComponent) },
  ...
  // Admin alternative layout (AdminTest)
  {
    path: 'AdminTest',
    ...
    children: [
      ...
      { path: 'movie/:id', component: MovieDeatils },
      { path: 'movies/add', component: AddMovie }
    ]
  },

  // Communication
  { path: 'support', loadComponent: () => import('./features/communication/components/customer-support/customer-support.component').then(m => m.CustomerSupportComponent) },
  { path: 'admin/chat', loadComponent: () => import('./features/communication/components/admin-chat/admin-chat.component').then(m => m.AdminChatComponent) },
